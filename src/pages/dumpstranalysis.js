...
// const savedValues = {
//     file: "./trio_chr21_hipstr.sorted.vcf.gz",
...
export const DumpstrAnalysis = () => {
    ...
    const handlFormSubmit = (values) => {
        ...
        var jobRequestOption = {
            method: 'GET',
        };

        fetch("http://localhost:5032/api/v1/dumpstr/noauth/jobs", requestOptions)
            .then(response => response.json())
            .then(result => {
                result = JSON.parse(result);
                setTimeout(() => {
                    fetch(`http://localhost:5032/api/v1/dumpstr/noauth/jobs/${result.jobId}`, jobRequestOption)
                        .then(response => response.json())
                        .then(result => {
                            const dumpFileUrl = `http://localhost:5032/api/v1/dumpstr/noauth/jobs${result?.data?.dumpFile}`;
                            // const dumpFileUrl = `http://localhost:5032${result?.data?.dumpFile}`;
                            const link = document.createElement('a');
                            link.href = dumpFileUrl;
                            link.download = 'dumpFile';
        ...
        <>
                    ...
                    <div>
                        ...
                        <Row className="mb-3">
                            <Form.Group as={Col} className="mb-3" controlId="email">
                                ...
                                <Field type="email" name="email" className="form-control" onChange={handleChange} value={values.email} />
                                <ErrorMessage name="email" component="div" className="text-danger" />
                            </Form.Group>
                            <Form.Group as={Col} controlId="job_name">
                                <Form.Label>job_name</Form.Label>
                                <Field type="text" name="job_name" className="form-control" onChange={handleChange} value={values.job_name} />
                                <ErrorMessage name="job_name" component="div" className="text-danger" />
                            </Form.Group>
                        </Row>
                        ...
                        <Accordion>
                                ...
                                <Accordion.Body>
                                    <Row className="mb-3">
                                        <Form.Group as={Col} controlId="vcftype">
                                            ...
                                            <Form.Select aria-label="Default select example" onChange={handleChange} name="vcftype" >
                                                <option>auto</option>
                                                <option value="advntr">advntr</option>
                                                <option value="hipstr">hipstr</option>
                                                <option value="gangstr">gangstr</option></Form.Select>
                                        </Form.Group>
                                    </Row>
                                    ...
                                    <Row className="mb-3">
                                        <Form.Group as={Col} controlId="num_records">
                                            ...
                                            <Field type="number" name="num_record" className="form-control" onChange={handleChange} value={values.num_records} />
                                            <ErrorMessage name="num_records" component="div" className="text-danger" />
                                        </Form.Group>
                                    </Row>
                                </Accordion.Body>
                            </Accordion.Item>
                                ...
                                <Accordion.Body>
                                    <Row className="mb-3">
                                        <Form.Group as={Col} controlId="min_locus_rate">
                                            ...
                                            <Field type="text" name="min_locus_rate" className="form-control" />
                                            <ErrorMessage name="min_locus_rate" component="div" className="text-danger" />
                                        </Form.Group>
                                        <Form.Group as={Col} controlId="min_locus_hwep">
                                            <Form.Label>min_locus_hwep</Form.Label>
                                            <Field type="text" name="min_locus_hwep" className="form-control" />
                                            <ErrorMessage name="min_locus_hwep" component="div" className="text-danger" />
                                        </Form.Group>
                                        <Form.Group as={Col} controlId="min_locus_het">
                                            <Form.Label>min_locus_het</Form.Label>
                                            <Field type="text" name="min_locus_het" className="form-control" />
                                            <ErrorMessage name="min_locus_het" component="div" className="text-danger" />
                                        </Form.Group>
                                    </Row>
                                    ...
                                    <Row className="mb-3">
                                        <Form.Group as={Col} controlId="max_locus_het">
                                            ...
                                            <Field type="text" name="max_locus_het" className="form-control" />
                                            <ErrorMessage name="max_locus_het" component="div" className="text-danger" />
                                        </Form.Group>
                                        <Form.Group as={Col} controlId="formFile" className="mb-3">
                                            <Form.Label>filter_regions</Form.Label> <Field
                                                // type="file" 
                                                type="text"
                                                name="filter_regions" className="form-control" />
                                            <ErrorMessage name="filter_regions" component="div" className="text-danger" />
                                        </Form.Group>
                                        <Form.Group as={Col} controlId="filter_regions_names">
                                            <Form.Label>filter_regions_names</Form.Label>
                                            <Field type="text" name="filter_regions_names" className="form-control" />
                                            <ErrorMessage name="filter_regions_names" component="div" className="text-danger" />
                                        </Form.Group>
                                    </Row>
                                </Accordion.Body>
                            </Accordion.Item>
                            ...
                            <Accordion.Item eventKey="2">
                                ...
                                <Accordion.Body>
                                    <Row className="mb-3">
                                        <Form.Group as={Col} controlId="hipstr_max_call_flank_indel">
                                            <Form.Label>hipstr_max_call_flank_indel</Form.Label>
                                            <Field type="text" name="hipstr_max_call_flank_indel" className="form-control" />
                                            <ErrorMessage name="hipstr_max_call_flank_indel" component="div" className="text-danger" />
                                        </Form.Group>
                                        <Form.Group as={Col} controlId="hipstr_max_call_stutter">
                                            <Form.Label>hipstr_max_call_stutter</Form.Label>
                                            <Field type="text" name="hipstr_max_call_stutter" className="form-control" />
                                            <ErrorMessage name="hipstr_max_call_stutter" component="div" className="text-danger" />
                                        </Form.Group>
                                        <Form.Group as={Col} controlId="hipstr_min_supp_reads">
                                            <Form.Label>hipstr_min_supp_reads</Form.Label>
                                            <Field type="text" name="hipstr_min_supp_reads" className="form-control" />
                                            <ErrorMessage name="hipstr_min_supp_reads" component="div" className="text-danger" />
                                        </Form.Group>
                                    </Row>
                                    ...
                                    <Row className="mb-3">
                                        <Form.Group as={Col} controlId="hipstr_min_call_DP">
                                            ...
                                            <Field type="text" name="hipstr_min_call_DP" className="form-control" />
                                            <ErrorMessage name="hipstr_min_call_DP" component="div" className="text-danger" />
                                        </Form.Group>
                                        <Form.Group as={Col} controlId="hipstr_max_call_DP">
                                            <Form.Label>hipstr_max_call_DP</Form.Label>
                                            <Field type="text" name="hipstr_max_call_DP" className="form-control" />
                                            <ErrorMessage name="hipstr_max_call_DP" component="div" className="text-danger" />
                                        </Form.Group>
                                        <Form.Group as={Col} controlId="hipstr_min_call_Q">
                                            <Form.Label>hipstr_min_call_Q</Form.Label>
                                            <Field type="text" name="hipstr_min_call_Q" className="form-control" />
                                            <ErrorMessage name="hipstr_min_call_Q" component="div" className="text-danger" />
                                        </Form.Group>
                                    </Row>
                                ...
                                <Accordion.Body>
                                    <Row className="mb-3">
                                        <Form.Group as={Col} controlId="gangstr_min_call_DPl">
                                            ...
                                            <Field type="text" name="gangstr_min_call_DPl" className="form-control" />
                                            <ErrorMessage name="gangstr_min_call_DPl" component="div" className="text-danger" />
                                        </Form.Group>
                                        <Form.Group as={Col} controlId="gangstr_max_call_D">
                                            <Form.Label>gangstr_max_call_D</Form.Label>
                                            <Field type="text" name="gangstr_max_call_D" className="form-control" />
                                            <ErrorMessage name="gangstr_max_call_D" component="div" className="text-danger" />
                                        </Form.Group>
                                        <Form.Group as={Col} controlId="gangstr_min_call_Q">
                                            <Form.Label>gangstr_min_call_Q</Form.Label>
                                            <Field type="text" name="gangstr_min_call_Q" className="form-control" />
                                            <ErrorMessage name="gangstr_min_call_Q" component="div" className="text-danger" />
                                        </Form.Group>
                                    </Row>
                                    ...
                                    <Row className="mb-3">
                                        <Form.Group as={Col} controlId="gangstr_expansion_prob_het">
                                            ...
                                            <Field type="text" name="gangstr_expansion_prob_het" className="form-control" />
                                            <ErrorMessage name="gangstr_expansion_prob_het" component="div" className="text-danger" />
                                        </Form.Group>
                                        <Form.Group as={Col} controlId="gangstr_expansion_prob_hom">
                                            <Form.Label>gangstr_expansion_prob_hom</Form.Label>
                                            <Field type="text" name="gangstr_expansion_prob_hom" className="form-control" />
                                            <ErrorMessage name="gangstr_expansion_prob_hom" component="div" className="text-danger" />
                                        </Form.Group>
                                        <Form.Group as={Col} controlId="gangstr_expansion_prob_total">
                                            <Form.Label>gangstr_expansion_prob_total</Form.Label>
                                            <Field type="text" name="gangstr_expansion_prob_total" className="form-control" />
                                            <ErrorMessage name="gangstr_expansion_prob_total" component="div" className="text-danger" />
                                        </Form.Group>
                                ...
                                <Accordion.Body>
                                    <Row className="mb-3">
                                        <Form.Group as={Col} controlId="advntr_min_spanning">
                                            ...
                                            <Field type="text" name="advntr_min_spanning" className="form-control" />
                                            <ErrorMessage name="advntr_min_spanning" component="div" className="text-danger" />
                                        </Form.Group>
                                        <Form.Group as={Col} controlId="advntr_min_flanking">
                                            <Form.Label>advntr_min_flanking</Form.Label>
                                            <Field type="text" name="advntr_min_flanking" className="form-control" />
                                            <ErrorMessage name="advntr_min_flanking" component="div" className="text-danger" />
                                        </Form.Group>
                                        <Form.Group as={Col} controlId="advntr_min_ML">
                                            <Form.Label>advntr_min_ML</Form.Label>
                                            <Field type="text" name="advntr_min_ML" className="form-control" />
                                            <ErrorMessage name="advntr_min_ML" component="div" className="text-danger" />
                                        </Form.Group>
                                    </Row>
                            ...
                            <Accordion.Item eventKey="5">
                                <Accordion.Header>ExpansionHunter Call-level Filters</Accordion.Header>
                                <Accordion.Body>

                                    <Row className="mb-3">
                                        <Form.Group as={Col} controlId="eh_min_call_LC">
                                            <Form.Label>eh_min_call_LC</Form.Label>
                                            <Field type="text" name="eh_min_call_LC" className="form-control" />
                                            <ErrorMessage name="eh_min_call_LC" component="div" className="text-danger" />
                                        </Form.Group>
                                        <Form.Group as={Col} controlId="eh_max_call_LC">
                                            <Form.Label>eh_max_call_LC</Form.Label>
                                            <Field type="text" name="eh_max_call_LC" className="form-control" />
                                            <ErrorMessage name="eh_max_call_LC" component="div" className="text-danger" />
                                        </Form.Group>
                                    </Row>
                                ...
                                <Accordion.Body>
                                    ...
                                    <Row className="mb-3">
                                        <Form.Group as={Col} controlId="popstr_min_call_DP">
                                            ...
                                            <Field type="text" name="popstr_min_call_DP" className="form-control" />
                                            <ErrorMessage name="popstr_min_call_DP" component="div" className="text-danger" />
                                        </Form.Group>
                                        <Form.Group as={Col} controlId="popstr_max_call_DP">
                                            <Form.Label>popstr_max_call_DP</Form.Label>
                                            <Field type="text" name="popstr_max_call_DP" className="form-control" />
                                            <ErrorMessage name="popstr_max_call_DP" component="div" className="text-danger" />
                                        </Form.Group>
                                        <Form.Group as={Col} controlId="popstr_require_support">
                                            <Form.Label>popstr_require_support</Form.Label>
                                            <Field type="text" name="popstr_require_support" className="form-control" />
                                            <ErrorMessage name="popstr_require_support" component="div" className="text-danger" />
                                        </Form.Group>
                                    </Row>
                                </Accordion.Body>
                            </Accordion.Item>
                        ...
                        <h1> </h1>
                        <button type='button' disabled={!isValid} onClick={handleSubmit}>Submit</button>
            ...
            <Modal show={show} onHide={handleClose}>
                <Modal.Header closeButton>
                    <Modal.Title>Analysis In Progress</Modal.Title>
                </Modal.Header>
                <Modal.Body>Click the'See Result' Button below to download your result</Modal.Body>
                <Modal.Footer>
                    <Button variant="secondary" onClick={handleClose}>
                        Close
                    </Button>
                    <Button variant="primary" onClick={dumpstrR}>
                        See Result
                    </Button>
                    {/* <Button
                        variant="contained"
                        ...
                        target={"_blank"}
                        // href={`/results${result?.data?.dumpFile}`}
                        href={`http://localhost:5032/api/v1/dumpstr/noauth/jobs/${result.jobId}${result?.data?.dumpFile}`}
                    >
                        Download Annotation Results
                    </Button> */}
                </Modal.Footer>
...
//                         .then((result) => console.log('RESELELELELELEL', result))
//                         .catch((error) => console.log('error: ', error))
//                 }, 15000)
//             })
//             .catch(error => console.log('error', error));
...
//         //                 .then((response) => response.json())
//         //                 .then((result) => {
//         //                     console.log('BEFORE PARSED', result);
//         //                     //    const filename= "/home/dzumi/trFiles/2a0fbbcd-45c1-485b-99a4-ba8348f07653/dumpstr/output/dump.vcf.gz"
//         //                     const filename = "/home/dzumi/trFiles/89e2a0c2-49e9-480c-8566-68f5114fd6de/dumpstr/output/dump.vcf.gz"
//         //                     downloadFile(filename)


//         // console.log("SJSSKSK", result?.data)
//         // const url = window.URL.createObjectURL(new Blob([...result?.data], { type: "application/zip" }));

//         // const link = document.createElement('a');
//         // link.href = url;
//         // link.download = `$result-{result?.data._id}`
//         // document.body.appendChild(link);
//         // link.click();


//         // window.open(result?.data.dumpFile)
//         // const link = document.createElement('a');
//         // console.log("LINK", link)
//         // link.href = result?.data?.dumpFile;
//         // link.click();
//         //                     })
//         //                     .catch((error) => console.log('error: ', error))
//         //             }, 20000)
