    ...
    return (
        <>
            ...
            <ButtonGroup size="lg" className="mb-2">
                <Button variant="light" onClick={gangstrA} className='card-button'>New Analysis</Button>
                <Button variant="light" onClick={gangstrR} className='card-button'>Results</Button>
            </ButtonGroup>
                        ...
                        <div class="Compare__1hUWQ">
                            <div class="MuiPaper-root Home_paper__1euug MuiPaper-outlined MuiPaper-rounded">
                                ...
                                <p>Please see full documentation and examples
                                    <a href="https://github.com/gymreklab/GangSTR" > here</a>
                                </p>
                                <p>
                                ...
                                <ol>
                                    ...
                                    <h3 className='card-title'>Additional general options:</h3>
                                    <ul>
                                    ...
                                    <h3 className='card-title'>Options for different sequencing settings</h3>
                                    <ul>
                                    ...
                                    <h3 className='card-title'>Advanced parameters for likelihood model:</h3>
                                    <ul>
                                    ...
                                    <h3 className='card-title'>Parameters for local realignment:</h3>
                                    ...
                                    <h3 className='card-title'>Stutter model parameters:</h3>
                                    <ul>
