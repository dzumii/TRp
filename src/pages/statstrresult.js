    ...
    return (
        <>
            ...
            <div className="mb-2 d-flex justifiy-content-center align-items -center" >
                <Link className="btn btn-light" to="/tools/statstr/statstranalysis">
                    New Analysis
                </Link>
                <Link
                    className="btn btn-light"
                    to={`/tools/statstr/statstrresult/${jobId}`}
                >
                    Results
                </Link>
            </div>
            ...
            {!loading && result.status === "completed" && (
                <div className="d-grid gap-2 w-50 p-4" >
                    <Button
                        ...
                        href={`${backendURL}/results${result.statFile}`}
                    >
                        Download Results
                    </Button>
                </div>
